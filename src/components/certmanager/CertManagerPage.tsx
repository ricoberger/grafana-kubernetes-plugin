...
export const CertManagerPage = () => {
  ...
  return (
    <PluginPage
      ...
      subTitle="Manage your cert-manager resources."
    >
      <SceneContextProvider
      ...
      >
        ...
        >
          <CustomVariable
            name="resourceId"
            label="Resource"
            query="Issuer : issuer.cert-manager.io, Order : order.acme.cert-manager.io, Challenge : challenge.acme.cert-manager.io, ClusterIssuer : clusterissuer.cert-manager.io, CertificateRequest : certificaterequest.cert-manager.io, Certificate : certificate.cert-manager.io"
            initialValue={DEFAULT_QUERIES['certmanager-resources'].resourceId}
          >
            <QueryVariable
              name="namespace"
              label="Namespace"
